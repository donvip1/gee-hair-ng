  ...
  return (
    <>
      ...
      <section className="story section page-shell" id="story">
        ...
        <div className="story-collage"><div className="story-tall"><Image src="/products/deep-waves.jpeg" alt="Gee Hair NG Deep Waves" fill sizes="50vw" /></div><div className="story-small"><Image src="/products/bone-straight.jpeg" alt="Gee Hair NG Bone Straight" fill sizes="30vw" /></div><span>{business.tagline}. </span></div>
      </section>
